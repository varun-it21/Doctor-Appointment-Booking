...
const Speciality = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
        ...
        <p className='sm:w-1/3 text-center text-sm'>Explore top specialists across various fields <br/> from dermatologists to neurologists and book your appointment with ease!</p>
